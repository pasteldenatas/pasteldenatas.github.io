...
function askRandomQuestionForConjugation() {
    ...
    var regularCheckbox = document.getElementById('option-regular');
    var irregularCheckbox = document.getElementById('option-irregular');
    var filteredVerbs = verbs.filter(function (verb) {
        if (regularCheckbox.checked && irregularCheckbox.checked)
            return true; // Both regular and irregular
    ...
    var verb = getRandomElement(filteredVerbs);
    var tenses = {
    ...
    if (questionElement && verbElement) {
        ...
        questionElement.textContent = "Como se conjuga no ".concat(tenseDisplay, " a ").concat(person, " ").concat(personDisplay);
    ...
    var verbTranslationElement = document.getElementById('verb-translation');
    // Display the translation
    if (verbTranslationElement) {
        verbTranslationElement.textContent = "(".concat(verb.translation, ")");
    }
}
...
function resetVerbLinksColor() {
    var links = document.querySelectorAll('.infinitive-link');
